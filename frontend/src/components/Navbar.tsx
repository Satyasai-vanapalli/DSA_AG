                ...
                <>
                  ...
                  <div className="flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-slate-700">
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-3 py-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer group"
                      title="Edit Profile"
                    >
                      <div className="w-9 h-9 rounded-full overflow-hidden border-2 border-primary-500/40 group-hover:border-primary-500 transition-colors flex-shrink-0">
