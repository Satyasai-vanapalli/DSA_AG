        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-dark-card rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-dark-border shadow-sm">
            ...
            <div className="space-y-3">
              {problem.problemLink && (
                <a href={problem.problemLink.startsWith('http') ? problem.problemLink : `https://${problem.problemLink}`} target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-semibold rounded-xl hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors">
                  <ExternalLink className="w-5 h-5" /> Solve Problem
                </a>
              )}
              {problem.youtubeLink && (
